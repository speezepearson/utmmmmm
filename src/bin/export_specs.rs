    ...
    let specs = vec![
        ...
        export_spec(
            ...
            |s| match s {
                ...
                // // Phase 0: Init — skip to end of rules to begin right-to-left rule search
                ...
                // // Phase 1: Mark Rule — pick the next rule to try (right-to-left)
                ...
                // // Phase 2: Compare State — compare rule's state field with current guest state
                ...
                // // State Match Cleanup — state matched, restore marks before comparing symbol
                ...
                // utm::State::StmGsSk1 => "skipping past accept states to reach state section",
                // utm::State::StmRestoreState => "restoring marked state section bits back to 0/1",
                // utm::State::StmBackToRule => "state restored; seeking star marker to begin symbol comparison",

                // // State Mismatch — state didn't match, clean up and try previous rule
                ...
                // // Phase 3: Compare Symbol — compare rule's symbol field with head cell
                ...
                // // Symbol Mismatch — symbol didn't match, restore and try previous rule
                ...
                // // Symbol Match Cleanup — full match, restore head cell and rule marks
                ...
                // // Phase 4: Apply Rule — copy new state bits from rule into state section
                ...
                // utm::State::CpNstNext => "at star; skipping past state bits in rule",
                // utm::State::CpNstNext2 => "skipping past symbol bits in rule to reach new-state field",
                ...
                // utm::State::CpNstRestNav => "navigating right to accept states section to check for marks",
                // utm::State::CpNstRestS1 => "skipping past accept states to reach state section",
                // utm::State::CpNstRestDo => "restoring any remaining marks in state section",

                // // Phase 5: Copy New Symbol — copy new symbol bits from rule into head cell
                // utm::State::CpNsymSeek => "new state written; seeking star marker to begin copying new symbol",
                // utm::State::CpNsymNav => "at star; skipping past state bits in rule",
                // utm::State::CpNsymNav2 => "skipping past symbol bits in rule",
                // utm::State::CpNsymNav3 => "skipping past new-state bits in rule to reach new-symbol field",
                ...
                // utm::State::CpNsymFnext => "at star; skipping past state bits in rule",
                // utm::State::CpNsymFn2 => "skipping past symbol bits in rule",
                // utm::State::CpNsymFn3 => "skipping past new-state bits in rule",
                ...
                // utm::State::CpNsymRestNav => "navigating right to restore marks in tape sections",
                // utm::State::CpNsymRnS1 => "restoring new symbol; skipping past accept states",
                // utm::State::CpNsymRnS2 => "restoring new symbol; skipping past state section",
                // utm::State::CpNsymRnS3 => "restoring new symbol; skipping past blank section",
                // utm::State::CpNsymRnFh => "restoring new symbol; finding head marker in tape",
                // utm::State::CpNsymRnDo => "restoring marked head cell bits back to 0/1",

                // // Phase 6: Read Direction — find the direction field in the matched rule
                // utm::State::ReadDir => "new symbol written; seeking star marker to read direction",
                // utm::State::RdSkipToDir => "skipping past state bits in rule toward direction field",
                // utm::State::RdSk2 => "skipping past symbol bits in rule toward direction field",
                // utm::State::RdSk3 => "skipping past new-state bits in rule toward direction field",
                // utm::State::RdSk4 => "skipping past new-symbol bits in rule toward direction field",
                // utm::State::RdRead => "reading direction: L or R",

                // // Move Right — shift head one cell to the right
                ...
                // // Move Right — Extend Tape (when moving past end of tape)
                ...
                // // Move Left — shift head one cell to the left
                ...
                // // Phase 7: Seek Home — move complete, return to $ to restart cycle
                // utm::State::DoneSeekHome => "head moved; seeking $ to restart simulation cycle",

                // // Phase 8: Check Accept States — no rule matched, check if current state is accepting
                ...
                // // Accept — current state is accepting, restore and halt
                ...
                // // Reject — no accept state matched, restore and halt
