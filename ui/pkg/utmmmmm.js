 ...
 * @param {string} utm_tape_str
 * @returns {string}
 */
export function decode(spec_json, utm_tape_str) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(spec_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(utm_tape_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @param {string} spec_json
 * @param {string} tape_str
 * @returns {string}
 */
export function encode(spec_json, tape_str) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(spec_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(tape_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('utmmmmm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
